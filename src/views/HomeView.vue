                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="index.html" class="nav-item nav-link active" @click.prevent="$router.push({name:'home'})">Home</a>
                            <a href="shop.html" class="nav-item nav-link" @click.prevent="$router.push({name:'shop'})">Shop</a>
                        ...
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <a href="" class="nav-item nav-link" @click.prevent="$router.push({name:'register'})">Register</a>
                        </div>
                    </div>
                </nav>
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="" class="cat-img position-relative overflow-hidden mb-3" @click.prevent="$router.push({name:'detail'})">
